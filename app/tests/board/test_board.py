...
def supply_check_returns_true() -> list[tuple[PieceTypes, str]]:
    return [
        (PieceTypes.queen, 'A1'),
        (PieceTypes.queen, 'F4'),
...
def supply_check_returns_false() -> list[tuple[PieceTypes, str]]:
    return [
        (PieceTypes.queen, 'A2'),
        (PieceTypes.queen, 'F3'),
...
@pytest.mark.parametrize("black_piece, piece_coordinates", supply_check_returns_true())
...
@pytest.mark.parametrize("black_piece, piece_coordinates", supply_check_returns_false())
