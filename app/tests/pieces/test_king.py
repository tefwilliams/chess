...
def test_king_can_only_move_to_adjacent_squares(
    ...
    king = create_pieces(PieceType.King, "F4", Color.White)
...
@pytest.mark.parametrize(
    ...
    [
        ("F3", create_pieces(PieceType.Bishop, "F3", Color.White)),
        ("E5", create_pieces(PieceType.Rook, "E5", Color.White)),
        ("G4", create_pieces(PieceType.Queen, "G4", Color.White)),
        ("E4", create_pieces(PieceType.Pawn, "E4", Color.White)),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("F3", create_pieces(PieceType.Bishop, "F3", Color.Black)),
        ("E5", create_pieces(PieceType.Rook, "E5", Color.Black)),
        ("G4", create_pieces(PieceType.Queen, "G4", Color.Black)),
        ("E4", create_pieces(PieceType.Pawn, "E4", Color.Black)),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("C1", [], True),
        ("G1", [create_pieces(PieceType.Rook, "E5", Color.Black)], False),
        ("C1", [create_pieces(PieceType.Rook, "E5", Color.Black)], False),
        # TODO - this should still fail after fixing castle rules
        ("G1", [create_pieces(PieceType.Rook, "E4", Color.Black)], True),
        ("C1", [create_pieces(PieceType.Rook, "E4", Color.Black)], False),
        ("B1", [create_pieces(PieceType.Rook, "E7", Color.Black)], False),
    ],
)
def test_king_can_move_via_castle(
    ...
    king = create_pieces(PieceType.King, "E1", Color.White)

    rooks = [
        create_pieces(PieceType.Rook, "A1", Color.White),
        create_pieces(PieceType.Rook, "H1", Color.White),
    ]
