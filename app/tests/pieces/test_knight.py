...
def test_knight_can_only_move_to_knight_squares(
    ...
    knight = create_pieces(PieceType.Knight, "F4", Color.White)
...
@pytest.mark.parametrize(
    ...
    [
        ("H3", create_pieces(PieceType.Bishop, "H3", Color.White)),
        ("E6", create_pieces(PieceType.Rook, "E6", Color.White)),
        ("D3", create_pieces(PieceType.Queen, "D3", Color.White)),
        ("G2", create_pieces(PieceType.Pawn, "G2", Color.White)),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("H3", create_pieces(PieceType.Bishop, "H3", Color.Black)),
        ("E6", create_pieces(PieceType.Rook, "E6", Color.Black)),
        ("D3", create_pieces(PieceType.Queen, "D3", Color.Black)),
        ("G2", create_pieces(PieceType.Pawn, "G2", Color.Black)),
    ],
)
